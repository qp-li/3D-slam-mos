...
if __name__ == '__main__':
    ...
    parser.add_argument('--demo-folder', type=str, default='/media/qipeng-li/ZX1 512G/lidar-dataset/dataset/Kitti_velodyne/data_odometry_velodyne/dataset/sequences/08/velodyne', help='path to the folder containing demo lidar scans')
    parser.add_argument('--save-folder', type=str, default='/home/qipeng-li/Cylinder3D/result', help='path to save your result')
